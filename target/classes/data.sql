drop table if exists fieldworker;
...
-- Populate fieldworkers

INSERT INTO fieldworker(id, first_name, last_name, ext_id) VALUES ('John', 'Smith', 'FWJS1');
INSERT INTO fieldworker(id, first_name, last_name, ext_id) VALUES ('Jane', 'Doe', 'FWJD1');
INSERT INTO fieldworker(id, first_name, last_name, ext_id) VALUES ('Edith', 'Smith', 'FWES1');
...
VALUES
   ('openhds-client-id', 'openhds-XY7kmzoNzl100', 'read,write', 'password,refresh_token,client_credentials,authorization_code', 'ROLE_CLIENT,ROLE_TRUSTED_CLIENT', 900, 2592000);